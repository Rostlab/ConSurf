...
sub compare_atom_seqres_or_msa{
    ...
    my $command = "cd ".$VARS{working_dir}."; ".CONSURF_CONSTANTS::CLUSTALW." -in ".$VARS{working_dir}."/".$two_fastas." -GAPOPEN=1 -out $VARS{working_dir}/$VARS{pairwise_aln} > ".$VARS{working_dir}."/".$clustalw_out;
