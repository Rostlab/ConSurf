// $Id: likeDist.cpp 646 2006-03-20 00:54:17Z eyalprivman $
...
const MDOUBLE likeDist::giveDistance(const sequence& s1,
				     const sequence& s2,
				     const vector<MDOUBLE>  * weights,
				     MDOUBLE* score) const {/*DEBUG*/ LOG(9,<<"likeDist::giveDistance - start"<<endl); LOGDO(9,printTime(myLog::LogFile())); /*DEBUG*/
