// $Id: generalGammaDistributionLaguerre.cpp 391 2005-06-12 12:44:57Z ninio $
...
const MDOUBLE generalGammaDistributionLaguerre::getCumulativeProb(const MDOUBLE x) const
{//	 
