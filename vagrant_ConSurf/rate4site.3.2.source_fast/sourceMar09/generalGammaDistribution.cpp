// $Id: generalGammaDistribution.cpp 391 2005-06-12 12:44:57Z ninio $
...
generalGammaDistribution::generalGammaDistribution(MDOUBLE alpha,MDOUBLE beta,int in_number_of_categories) :distribution(){
	_globalRate=1.0;
...
int generalGammaDistribution::fill_mean() {
	fill_bonderi();
	int i;
...
int generalGammaDistribution::fill_bonderi() {
	int i;
