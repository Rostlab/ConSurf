// $Id: computePijComponent.h 391 2005-06-12 12:44:57Z ninio $
...
public:
	...
	void fillPij(const MDOUBLE dis, const stochasticProcess& sp, int derivationOrder = 0);
...
public:
	...
	void fillPij(const tree& et, const stochasticProcess& sp, int derivationOrder = 0);
