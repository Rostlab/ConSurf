// $Id: readDatMatrix.h 435 2005-08-01 12:57:47Z ninio $
...
public:
	...
	explicit pupAll(const datMatrixString& matrixFileString) : err_allow_for_pijt_function(1e-4) {fillMatrices(matrixFileString.Val);}
...
private:
	...
	void fillMatrices(const string & matrixName);
